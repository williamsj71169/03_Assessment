...
class Help:
    def __init__(self, partner):
        ...
        help_text = "Choose and amount to play with and then choose the rounds." \
                    "Higher rounds cost more per round but you can win more as well.\n\n" \
                    ...
                    "The contents of the boxes will be added to your score. The boxes could contain...\n\n" \
...
class GameStats:
    def __init__(self, partner, game_history, game_stats):
        ...
        self.start_score_label = Label(self.details_frame, text="Starting Score: ",
                                         font=heading, anchor="e")
        self.start_score_label.grid(row=0, column=0, padx=0)

        self.start_score_value_label = Label(self.details_frame, font=content,
                                               text="${}".format(game_stats[0]))   # meant to something else here
        self.start_score_value_label.grid(row=0, column=1, padx=0)

        # current score (row 2.2)
        self.current_score_label = Label(self.details_frame, text="Current Score: ",
                                           font=heading, anchor="e")
        self.current_score_label.grid(row=1, column=0, padx=0)

        self.current_score_value_label = Label(self.details_frame, font=content,
                                                 text="${}".format(game_stats[1]))  # meant to something else here
        self.current_score_value_label.grid(row=1, column=1, padx=0)
